namespace CapaPresentacion
{
    partial class frmAperturaCuenta
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.AhorrosDataSet = new CapaPresentacion.AhorrosDataSet();
            this.AhoRepoApeCuenta_spBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.AhoRepoApeCuenta_spTableAdapter = new CapaPresentacion.AhorrosDataSetTableAdapters.AhoRepoApeCuenta_spTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "CapaPresentacion.rptApertura.rdlc";
